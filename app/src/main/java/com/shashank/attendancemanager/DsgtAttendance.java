...
public class DsgtAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsgt_attendance);
        recyclerView=findViewById(R.id.dsgt_recylerview);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("teachers").child("DSGT");
        /*final ProgressDialog progressDialog=new ProgressDialog(DsgtAttendance.this);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter=new AttendanceAdapter(DsgtAttendance.this,studentsDataList);
                mLayoutManager=new LinearLayoutManager(DsgtAttendance.this);
