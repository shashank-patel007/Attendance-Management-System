...
public class MathsAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths_attendance);
        recyclerView=findViewById(R.id.maths_recylerview);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("teachers").child("Maths");
        /*final ProgressDialog progressDialog=new ProgressDialog(MathsAttendance.this);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter=new AttendanceAdapter(MathsAttendance.this,studentsDataList);
                mLayoutManager=new LinearLayoutManager(MathsAttendance.this);
