...
public class DldaAttendance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dlda_attendance);
        recyclerView=findViewById(R.id.dlda_recylerview);
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("teachers").child("DLDA");
        /*final ProgressDialog progressDialog=new ProgressDialog(DldaAttendance.this);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter=new AttendanceAdapter(DldaAttendance.this,studentsDataList);
                mLayoutManager=new LinearLayoutManager(DldaAttendance.this);
